...
//           >
//             <div className="absolute top-5 left-10 w-15 h-15 bg-green-200 rounded-full opacity-20 animate-pulse" />
//             <div className="absolute bottom-10 right-10 w-16 h-16 bg-emerald-200 rounded-full opacity-20 animate-pulse delay-1000" />
//             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-45 h-45 bg-green-100 rounded-full opacity-10 animate-pulse delay-500" />
//           </motion.div>
